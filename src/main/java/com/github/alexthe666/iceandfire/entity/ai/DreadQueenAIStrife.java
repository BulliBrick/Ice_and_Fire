...
// not sure if correct way to implement range attack of queen, same logic as lich

public class DreadQueenAIStrife extends Goal {

    private final EntityDreadQueen entity;
    ...
    public DreadQueenAIStrife(EntityDreadQueen mob, double moveSpeedAmpIn, int attackCooldownIn, float maxAttackDistanceIn) {
        this.entity = mob;
    ...
    protected boolean isStaffInHand() {
        return !this.entity.getHeldItemMainhand().isEmpty() && this.entity.getHeldItemMainhand().getItem() == IafItemRegistry.DREAD_QUEEN_STAFF;
    }
