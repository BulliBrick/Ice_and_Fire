...
public class EntityDreadQueenSkull extends AbstractArrowEntity {


    public EntityDreadQueenSkull(EntityType<? extends AbstractArrowEntity> type, World worldIn) {
        super(type, worldIn);
        this.setDamage(7F);
    }
    ...
    public EntityDreadQueenSkull(FMLPlayMessages.SpawnEntity spawnEntity, World worldIn) {
