...
public class EntityDreadQueenSkull extends AbstractArrow {


    public EntityDreadQueenSkull(EntityType<? extends AbstractArrow> type, Level worldIn) {
        super(type, worldIn);
        this.setBaseDamage(6F);
    }

    public EntityDreadQueenSkull(EntityType<? extends AbstractArrow> type, Level worldIn, double x, double y,
                                 double z) {
        this(type, worldIn);
        this.setPos(x, y, z);
        this.setBaseDamage(6F);
    ...
    public EntityDreadQueenSkull(EntityType<? extends AbstractArrow> type, Level worldIn, LivingEntity shooter,
    ...
    public EntityDreadQueenSkull(PlayMessages.SpawnEntity spawnEntity, Level worldIn) {
        this(IafEntityRegistry.DREAD_QUEEN_SKULL.get(), worldIn);
    }
