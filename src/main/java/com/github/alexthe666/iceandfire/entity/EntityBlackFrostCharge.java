...
public class EntityBlackFrostCharge extends EntityDragonCharge {
    ...
    public EntityBlackFrostCharge(EntityType<? extends Fireball> type, Level worldIn) {
        super(type, worldIn);

    }

    public EntityBlackFrostCharge(PlayMessages.SpawnEntity spawnEntity, Level worldIn) {
        this(IafEntityRegistry.BLACK_FROST_CHARGE.get(), worldIn);
    }

    public EntityBlackFrostCharge(EntityType<? extends Fireball> type, Level worldIn, double posX,
