...
public class EntityBlackFrostCharge extends EntityDragonCharge {
    public EntityBlackFrostCharge(EntityType<? extends AbstractFireballEntity> type, World worldIn) {
        super(type, worldIn);
    }
    public EntityBlackFrostCharge(FMLPlayMessages.SpawnEntity spawnEntity, World worldIn) {
        this(IafEntityRegistry.BLACK_FROST_CHARGE.get(), worldIn);
    }

    public EntityBlackFrostCharge(EntityType<? extends AbstractFireballEntity> type, World worldIn, double posX,
