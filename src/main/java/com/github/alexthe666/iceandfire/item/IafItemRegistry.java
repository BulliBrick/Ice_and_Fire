...
public class IafItemRegistry {
    ...
    public static void registerItems(RegistryEvent.Register<Item> event) {
        ...
        ITEMS.register("spawn_egg_dread_queen", () -> new ForgeSpawnEggItem(IafEntityRegistry.DREAD_QUEEN, 0X3A3A3A, 0X7B7B7B, new Item.Properties().tab(IceAndFire.TAB_ITEMS)));
